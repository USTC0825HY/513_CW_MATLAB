...
%DAC_ISOLATION_ANALYSIS Run the standalone DA766 isolation analysis.
bootstrapRuntime();
config = da766Config('isolation');
if nargin < 1 || isempty(dataFolder), dataFolder = uigetdir(pwd, '选择DA766隔离度数据目录'); end
