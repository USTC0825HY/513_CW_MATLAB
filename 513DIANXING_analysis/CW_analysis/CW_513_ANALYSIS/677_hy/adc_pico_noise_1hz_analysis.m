...
% Only a unique waveform is inferred; an explicit channel is never replaced.
capture = converter.io.loadPicoMat(char(capturePath), cfg.waveVariable, 1, true);
...
cfg = struct('analysisId', 'ad677_pico_noise_1hz', 'version', '1.0.0', ...
    ...
    'referencePlane', deviceConfig.referencePlane, 'plotDpi', 180, 'waveVariable', '', ...
