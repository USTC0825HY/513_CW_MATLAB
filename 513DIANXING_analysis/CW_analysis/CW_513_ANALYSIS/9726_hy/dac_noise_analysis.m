...
%DAC_NOISE_ANALYSIS Run the standalone DA9726 ASD-only noise analysis.
bootstrapRuntime();
config = da9726Config('noise');
...
if nargin < 1 || isempty(dataFolder), dataFolder = uigetdir(pwd, '选择DA9726噪声MAT目录'); end
