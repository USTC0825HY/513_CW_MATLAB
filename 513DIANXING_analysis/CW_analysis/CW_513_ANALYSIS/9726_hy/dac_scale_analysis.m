...
%DAC_SCALE_ANALYSIS Run the standalone DA9726 scale analysis.
bootstrapRuntime();
config = da9726Config('scale');
...
if nargin < 1 || isempty(dataFolder), dataFolder = uigetdir(pwd, '选择DA9726刻度MAT目录'); end
