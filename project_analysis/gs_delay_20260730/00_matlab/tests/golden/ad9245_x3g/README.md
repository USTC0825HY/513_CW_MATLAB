...
这些小型 CSV 使用标签 `ad9245-pre-refactor-20260808` 的代码和
`513_GS_AD_DATA/AD9245` 五项 X3G 原始数据重新生成，仅用于对比数值和字段，
不包含原始采样数据。2026-08-08 已验证重构版五张结果表与基线表 `isequaln` 完全相等。
...
| ADC_power_scale_summary.csv | EFD2AB87D4AB14E8A3B2F08C741206C5EB4B17B4360E2AC4C3C7B691687F9166 |
